...
# 1. Assign roles for the CI/CD project
...
# 2. Assign deployment roles for target projects (staging and prod)
...
# 4. Allow the CI/CD SA to create tokens & impersonate app SA
