...
variable "create_repository" {
  description = "Flag indicating whether to create a new GitHub repository"
  type        = bool
  default     = false
}
...
variable "host_connection_name" {
  ...
  type        = string
  default     = "blueprint-agent-github-connection"
}

variable "enable_github_actions" {
  description = "Flag to enable GitHub Actions variables, secrets, and WIF configuration"
  type        = bool
  default     = true
}

variable "enable_cloud_build" {
  description = "Flag to enable Cloud Build triggers"
  type        = bool
  default     = false
}
